  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {!isAdmin && (
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-[#faf8f5] text-slate-600 border border-[#e8e2d5]">
      ...
      {!isAdmin ? (
        <div className="space-y-6">
          <div className="bg-[#1c3541] text-white p-6 sm:p-8 rounded-3xl shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6 border border-white/10">
            <div>
              <div className="text-xs uppercase font-semibold text-[#e5b869] tracking-wider mb-1">
                      ...
                      <tr key={emp.id || empLoginId} className="hover:bg-[#faf6f0] transition-colors">
                        ...
                        <td className="py-4 px-4 text-right">
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-[#1c3541] hover:bg-[#28495a] text-white text-xs font-semibold transition-all cursor-pointer inline-flex items-center gap-1.5"
                          >
          ...
          <div className="bg-white max-w-lg w-full rounded-2xl border border-[#e8e2d5] shadow-2xl p-6 sm:p-8 animate-fade-in space-y-6">
            ...
            <form onSubmit={handleSaveWage} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-[#f3efe6]">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 rounded-xl bg-[#1c3541] hover:bg-[#28495a] text-white font-semibold text-xs shadow-xs cursor-pointer flex items-center gap-1.5"
                >
